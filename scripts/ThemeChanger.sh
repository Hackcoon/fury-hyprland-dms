...
if wallust theme -- "${choice}"; then
  ...
  # Kitty reload SKIPPED by vault choice (2026-09-24) — wallust still
  # regenerates its theme file, but running kitties keep current colors.
  # Restore: re-add SIGUSR1 loop below.
